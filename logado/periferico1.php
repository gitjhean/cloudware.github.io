...
<body>
    ...
    <main>
        <div id="product-info">
            <div id="blank"></div>
            <div id="blank2"></div>
            <h1 id="product-name">Headset Gamer Redragon Zeus X, Chroma Mk.II, RGB, Surround 7.1, USB, Drivers 53MM, Preto/Vermelho - H510-RGB
            </h1>
            <picture>
                <img src="periferico1.jpg" id="product-image">
            </picture>
            <div id="product-detail">
                <p id="product-value">
                    <span>R$ 259,99</span> à vista <br>
                    <span id="pix-price">no PIX com 10% de desconto</span>
                </p>
                <p id="product-method">
                    <span id="span1">R$ 285,98</span> <br>
                    Em até 10x de <span id="span2"> R$ 28,59</span> sem juros no cartão <br>
                    Ou em 1x no cartão com até <span id="span3">5% OFF</span>
                </p>
                <a href="pagamentop1.php"><p id="buy-button">
                    Comprar
                </p></a>
            </div>
        </div>   
        ...
        <div id="product-desc">
            ...
            <p id="product-technical">
               <strong>Headset Gamer Redragon Zeus X, USB, RGB Chroma Mk.II, Surround 7.1, Drivers 53mm, Preto/Vermelho</strong> <br> <br>
 
                <strong>Recursos:</strong> <br>
                • Iluminação RGB Redragon Chroma Mk.II com 4 efeitos. <br>
                • Almofadas e revestimento interno do arco em tecido para proporcionar o máximo de conforto. <br>
                • Som estéreo e Surround 7.1 Virtual de alta qualidade pelos drivers de 53mm. <br> 
                • Microfone com redução de ruído de fundo para captação clara e limpa. <br> 
                • Controladora integrada para maior praticidade durante o uso. <br>
                • Compatível com software para ajustes e configurações personalizadas como equalização e controle de volume independente.
            </p>
        </div>
        <footer>
            <p></p>
