...
<body>
    ...
    <nav>
        <li>
            ...
            <ul class="navmenu" id="menu-notebooks">Notebooks</ul>
    ...
    <main>
        ...
        <div id="product-area">
            <p id="area-info">Notebooks</p>
            <a href="notebook1.php" class="link"><div id="item1" class="product-template">
                <img src="notebook1.jpg" alt="" id="product-image">
                <p id="product-description">Notebook Gamer Dell G15 Intel Core i5-13450HX, 8GB RAM, 
                GeForce RTX 3050 6GB, SSD 512GB, 15.6 Full HD 120Hz, Windows 11 Home, Preto - G15-i1300-A20P <br>
                </p>
                <p id="product-price">
            ...
            <a href="notebook2.php" class="link"><div id="item2" class="product-template">
                <img src="notebook2.jpg" alt="" id="product-image">
                <p id="product-description">Notebook Samsung Galaxy Book2 Intel Core i5-1235U, 8GB RAM, SSD 256GB, 15.6" Full HD, Windows 11 Home, Grafite - NP550XED-KF2BR <br>
                <br>
                </p>
                <p id="product-price">
            ...
            <a href="notebook3.php" class="link"><div id="item3" class="product-template">
                <img src="notebook3.jpg" alt="" id="product-image">
                <p id="product-description">Notebook Acer Aspire 3 AMD Ryzen 5-7520U, 16GB RAM, SSD 512GB, 15.6" HD, AMD Radeon Graphics, Linux Gutta, Prata - A315-24P-R3CQ <br>
                <br>
                </p>
                <p id="product-price">
