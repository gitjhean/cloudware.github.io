...
<body>
    ...
    <main>
        <div id="product-info">
            <div id="blank"></div>
            <div id="blank2"></div>
            <h1 id="product-name">Placa de Vídeo RTX 4090 Asus NVIDIA 
                TUF Gaming GeForce Edition, 24GB GDDR6X, DLSS, Ray Tracing - TUF-RTX4090-O24G-GAMING
            </h1>
            <picture>
                <img src="rtx 4090.jpg" id="product-image">
            </picture>
            <div id="product-detail">
                <p id="product-value">
                    <span>R$ 12.899,99</span> à vista <br>
                    <span id="pix-price">no PIX com 10% de desconto</span>
                </p>
                <p id="product-method">
                    <span id="span1">R$ 14.189,99</span> <br>
                    Em até 10x de <span id="span2"> R$ 1.418,99</span> sem juros no cartão <br>
                    Ou em 1x no cartão com até <span id="span3">5% OFF</span>
                </p>
                <a href="pagamentor.php"><p id="buy-button">
                    Comprar
                </p></a>
            </div>
        </div>   
        ...
        <div id="product-desc">
            ...
            <p id="product-technical">
                <strong>Placa de Vídeo ASUS NVIDIA TUF Gaming GeForce RTX4090 Edition, 24 GB GDDR6X, DLSS, Ray Tracing</strong> <br> <br>
 
                <strong>Armado para Fluxo</strong> <br> 
                A arquitetura NVIDIA Ada Lovelace elevada por resfriamento aprimorado e fornecimento de energia, e apoiada por um arsenal de reforços robustos para cobrir seus seis.
                Bloqueie, carregue e domine com a TUF Gaming GeForce RTX 4090. <br> <br>

                <strong>Resfriamento</strong> <br>
                Uma cobertura fundida e uma placa traseira de alumínio otimizado para trabalho de fluxo de ar em conjunto com ventiladores Axial-tech redesenhados que mudam 23% mais ar,
                mantendo os níveis de ruído baixos e GPU temperaturas sob controle rígido. <br> <br>

                <strong>Durabilidade</strong> <br>
                Capacitores de longa duração, rolamentos de esferas duplas e um processo de fabricação automatizado garante longa confiabilidade de prazo para sua compilação de jogos. <br> <br>

                <strong>Estética</strong> <br>
                Uma pitada de iluminação Aura RGB brilha através do Logo TUF, adicionando uma camada de personalização através de uma gama de decoração e funcional efeitos. <br> <br>

                <strong>Software</strong> <br>
                Hardware e software se unem para permitir que você personalizar totalmente sua experiência e obter o máximo fora de sua placa gráfica. 
                GPU Tweak III permite ajustes de hardware e monitoramento, e O QuantumCloud utiliza sua computação GPU sobressalente poder de gerar renda passiva.
            </p>
        </div>
        <footer>
            <p></p>
