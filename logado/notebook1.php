...
<body>
    ...
    <main>
        <div id="product-info">
            <div id="blank"></div>
            <div id="blank2"></div>
            <h1 id="product-name">Notebook Gamer Dell G15 Intel Core i5-13450HX, 8GB RAM, 
            GeForce RTX 3050 6GB, SSD 512GB, 15.6 Full HD 120Hz, Windows 11 Home, Preto - G15-i1300-A20P
            </h1>
            <picture>
                <img src="notebook1.jpg" id="product-image">
            </picture>
            <div id="product-detail">
                <p id="product-value">
                    <span>R$ 4.999,99</span> à vista <br>
                    <span id="pix-price">no PIX com 10% de desconto</span>
                </p>
                <p id="product-method">
                    <span id="span1">R$ 5.499,98</span> <br>
                    Em até 10x de <span id="span2"> R$ 549,99</span> sem juros no cartão <br>
                    Ou em 1x no cartão com até <span id="span3">5% OFF</span>
                </p>
                <a href="pagamenton1.php"><p id="buy-button">
                    Comprar
                </p></a>
            </div>
        </div>   
        ...
        <div id="product-desc">
            ...
            <p id="product-technical">
                <strong>Notebook Gamer Dell G15-i1300-A20P</strong> <br> <br>
 
                <strong>Intensifique A Ação</strong> <br>
                Intensifique a ação. Com o novo notebook Dell G15 Gaming você terá uma incrível experiência em um notebook com um desempenho excepcional.
                Este notebook conta com a 13ª geração de processadores Intel Core, que fornecem um desempenho poderoso.
                As placas gráficas NVIDIA GeForce RTX utilizam a arquitetura NVIDIA Ampere, com novos núcleos RT, núcleos Tensor e multiprocessadores de streaming para recursos gráficos realistas com Ray Tracing. <br> <br>

                <strong>Teclado Iluminado E Design Térmico</strong> <br>
                O G15 Gaming possui teclado em português retroiluminado com iluminação laranja e marcações WASD, perfeito para jogar em ambientes com baixa luminosidade.
                O design térmico incorpora uma entrada de ar dupla. Esse ar é então expelido por quatro saídas maximizar o fluxo de ar, proporcionando a refrigeração ideal. <br> <br>

                <strong>Alta Potência</strong> <br>
                Os mais recentes avanços no design térmico proporcionam ao Dell G15 a capacidade de fornecer potência ampla e adaptar-se a uma carga de sistema dinâmica.
                 Assim, os componentes permanecem mais frios, e a velocidade de clock permanece mais alta até na execução dos aplicativos mais exigentes. <br> <br>
            </p>
        </div>
