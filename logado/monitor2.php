...
<body>
    ...
    <main>
        <div id="product-info">
            <div id="blank"></div>
            <div id="blank2"></div>
            <h1 id="product-name">Monitor Gamer LG 26" Ultra Wide, 75Hz, Full HD, 1ms, IPS, HDMI, FreeSync Premium, HDR 10, 99% sRGB, VESA - 26WQ500
            </h1>
            <picture>
                <img src="monitor2.jpg" id="product-image">
            </picture>
            <div id="product-detail">
                <p id="product-value">
                    <span>R$ 649,99</span> à vista <br>
                    <span id="pix-price">no PIX com 10% de desconto</span>
                </p>
                <p id="product-method">
                    <span id="span1">R$ 714,98</span> <br>
                    Em até 10x de <span id="span2"> R$ 71,49</span> sem juros no cartão <br>
                    Ou em 1x no cartão com até <span id="span3">5% OFF</span>
                </p>
                <a href="pagamentom2.php"><p id="buy-button">
                    Comprar
                </p></a>
            </div>
        </div>   
        ...
        <div id="product-desc">
            ...
            <p id="product-technical">
               <strong>Monitor Gamer LG 26" IPS</strong> <br> <br>
 
                Multitarefa sem minimizar: Mantenha tudo em uma tela com a marca de monitores UltraWide nº 1 nos EUA por 4 anos consecutivos*.
                Veja mais e faça mais nesta tela UltraWide™ Full HD (2560x1080). 
                Com 33% a mais de espaço na tela em largura do que a tela de resolução FHD (1920x1080), você pode realizar várias tarefas com eficiência, sem alternar entre os programas. <br> <br>

                <strong> Cada Movimento Conta</strong> <br>
                Com 1ms MBR, veja movimentos mais suaves e menos atrasos para que você possa reagir aos movimentos rapidamente, colocando você no topo do seu jogo. <br> <br>

                <strong> AMD FreeSync Premium</strong> <br>
                Equipa os jogadores sérios com uma experiência de jogo fluida e praticamente sem rasgos. 
                Com taxa de atualização de pelo menos 120 hz com resolução FHD mínima e jogabilidade de baixa latência, você nunca perderá um quadro da ação enquanto joga com desempenho máximo.
            </p>
        </div>
