...
<body>
    ...
    <main>
        <div id="product-info">
            <div id="blank"></div>
            <div id="blank2"></div>
            <h1 id="product-name">PC Gamer Neologic AMD Ryzen 5 5600g Radeon Vega 7 Integrado, 16GB 3200mhz, SSD 480GB M.2, Fonte 500w 80 Plus - Nli86304
            </h1>
            <picture>
                <img src="pcgamer3.jpg" id="product-image">
            </picture>
            <div id="product-detail">
                ...
                <p id="product-method">
                    <span id="span1">R$ 3,124.58</span> <br>
                    Em até 10x de <span id="span2"> R$ 312,45</span> sem juros no cartão <br>
                    Ou em 1x no cartão com até <span id="span3">5% OFF</span>
                </p>
                <a href="pagamentog3.php"><p id="buy-button">
                    Comprar
                </p></a>
            </div>
        </div>   
