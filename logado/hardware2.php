...
<body>
    ...
    <main>
        <div id="product-info">
            <div id="blank"></div>
            <div id="blank2"></div>
            <h1 id="product-name">Fonte MSI MAG A650BN, 650W, 80 Plus Bronze, PFC Ativo, com cabo, Preto - 306-7ZP2B22-CE0
            </h1>
            <picture>
                <img src="hardware2.jpg" id="product-image">
            </picture>
            <div id="product-detail">
                <p id="product-value">
                    <span>R$ 279,99</span> à vista <br>
                    <span id="pix-price">no PIX com 10% de desconto</span>
                </p>
                <p id="product-method">
                    <span id="span1">R$ 307,98</span> <br>
                    Em até 10x de <span id="span2"> R$ 30,79</span> sem juros no cartão <br>
                    Ou em 1x no cartão com até <span id="span3">5% OFF</span>
                </p>
                <a href="pagamentoh2.php"><p id="buy-button">
                    Comprar
                </p></a>
            </div>
        </div>   
        ...
        <div id="product-desc">
            ...
            <p id="product-technical">
                <strong>Fonte MSI MAG A650BN</strong> <br> <br>
 
                Oferece aos jogadores uma opção de fonte de alimentação de nível básico segura, confiável e eficiente. 
                Seus principais recursos incluem certificação 80 PLUS Bronze, design de circuito DC para DC, trilho único de 12V, PFC ativo e ventoinha de baixo ruído. 
                O MAG A550BN será uma das melhores escolhas para jogadores que estão apenas começando a olhar para computadores DIY. Após a instalação, os jogadores podem desfrutar 
                imediatamente de uma experiência de desempenho confiável sem configurações adicionais. <br> <br>

                <strong>80 PLUS BRONZE CERTIFICADO</strong> <br>
                A eficiência de sua fonte de alimentação influencia diretamente o desempenho de seu sistema e seu consumo de energia. A certificação 80 PLUS BRONZE promete menor consumo de energia e maior eficiência. <br> <br>
 
                <strong>VENTILADOR DE BAIXO RUÍDO DE 120 MM</strong> <br>
                O mancal da ventoinha reduz o ruído gerado, mantendo uma excelente dissipação de calor. <br> <br>

                <strong>PROJETO DE CIRCUITO DC PARA DC</strong> <br>
                O projeto de circuito DC-DC adotado reduz a instabilidade da tensão de saída e aumenta a estabilidade do fornecimento de energia. <br> <br>

                <strong>PROTEÇÃO ABRANGENTE DE CIRCUITO</strong> <br>
                Suporta mecanismos de proteção OCP, OVP, SCP, OPP, OTP e fornece proteção abrangente. <br> <br>
            </p>
        </div>
