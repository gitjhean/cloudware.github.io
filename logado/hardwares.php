...
<body>
    ...
    <nav>
        <li>
            ...
            <ul class="navmenu" id="menu-hardwares">Hardwares</ul>
    ...
    <main>
        ...
        <div id="product-area">
            <p id="area-info">Hardwares</p>
            <a href="hardware1.php" class="link"><div id="item1" class="product-template">
                <img src="hardware1.jpg" alt="" id="product-image">
                <p id="product-description">SSD 500 GB Kingston NV2, M.2 2280 PCIe, NVMe, 
                Leitura: 3500 MB/s e Gravação: 2100 MB/s - SNV2S/500G <br>
                <br>
                </p>
                <p id="product-price">
            ...
            <a href="hardware2.php" class="link"><div id="item2" class="product-template">
                <img src="hardware2.jpg" alt="" id="product-image">
                <p id="product-description">Fonte MSI MAG A650BN, 650W, 80 Plus Bronze, PFC Ativo, com cabo, Preto - 306-7ZP2B22-CE0 <br>
                <br>
                </p>
                <p id="product-price">
            ...
            <a href="hardware3.php" class="link"><div id="item3" class="product-template">
                <img src="hardware3.jpg" alt="" id="product-image">
                <p id="product-description">Placa de Vídeo RX 6600 V2 ASUS Dual AMD Radeon, 8GB GDDR6 - 90YV0GP2-M0NA00 <br>
                <br>
                </p>
                <p id="product-price">
