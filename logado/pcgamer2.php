...
<body>
    ...
    <main>
        <div id="product-info">
            <div id="blank"></div>
            <div id="blank2"></div>
            <h1 id="product-name">Pc Gamer Verdant, AMD Ryzen 5600g, 16GB DDR4, Radeon Vega 7, SSD 480GB, Windows 10 Trial - Preto
            </h1>
            <picture>
                <img src="pcgamer2.jpg" id="product-image">
            </picture>
            <div id="product-detail">
                ...
                <p id="product-method">
                    <span id="span1">R$ 2.315,50</span> <br>
                    Em até 10x de <span id="span2"> R$ 231,55</span> sem juros no cartão <br>
                    Ou em 1x no cartão com até <span id="span3">5% OFF</span>
                </p>
                <a href="pagamentog2.php"><p id="buy-button">
                    Comprar
                </p></a>
            </div>
        </div>   
