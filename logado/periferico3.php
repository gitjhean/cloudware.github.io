...
<body>
    ...
    <main>
        <div id="product-info">
            <div id="blank"></div>
            <div id="blank2"></div>
            <h1 id="product-name">Teclado Gamer Semi Mecânico Rise Mode G1 Full, USB, Branco - RM-TG-01-FW
            </h1>
            <picture>
                <img src="periferico3.jpg" id="product-image">
            </picture>
            <div id="product-detail">
                ...
                <p id="product-method">
                    <span id="span1">R$ 37,98</span> <br>
                    Em até 10x de <span id="span2"> R$ 3,79</span> sem juros no cartão <br>
                    Ou em 1x no cartão com até <span id="span3">5% OFF</span>
                </p>
                <a href="pagamentop3.php"><p id="buy-button">
                    Comprar
                </p></a>
            </div>
        </div>   
        ...
        <div id="product-desc">
            ...
            <p id="product-technical">
                <strong>Teclado Gamer Rise Mode G1 Full, USB, Branco - RM-TG-01-FW</strong> <br> <br>

                Você está procurando um teclado para jogos de alta qualidade? Então o teclado Gamer Rise Mode G1 é exatamente o que você precisa! 
                Este teclado é projetado especificamente para jogadores e vem com uma série de recursos impressionantes, incluindo LEDs Rainbow que lhe dão uma aparência verdadeiramente espetacular. 
                O teclado Gamer Rise Mode G1 é um dispositivo de alto desempenho que permitirá que você desfrute de uma experiência de jogo incomparável. <br>
                As teclas foram especialmente desenhadas para oferecer uma resposta rápida e precisa.
            </p>
        </div>
        <footer>
            <p></p>
