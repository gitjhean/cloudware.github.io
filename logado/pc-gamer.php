...
<body>
    ...
    <nav>
        <li>
            <ul class="navmenu" id="menu-pcgamer">PC Gamer</ul>
    ...
    <main>
        ...
        <div id="product-area">
            <p id="area-info">Computadores</p>
            <a href="pcgamer1.php" class="link"><div id="item1" class="product-template">
                <img src="pcgamer1.jpg" alt="" id="product-image">
                <p id="product-description">PC Gamer AMD Ryzen 5 5600x, 16GB, DDR4, Nvme 1TB, Rtx 4060, 8GB <br>
                <br>
                <br>
                </p>
                <p id="product-price">
                    <span>R$ 7.118,88</span> à vista <br>
            ...
            <a href="pcgamer2.php" class="link"><div id="item2" class="product-template">
                <img src="pcgamer2.jpg" alt="" id="product-image">
                <p id="product-description">Pc Gamer Verdant, AMD Ryzen 5600g, 16GB DDR4, Radeon Vega 7, SSD 480GB, Windows 10 Trial - Preto <br>
                <br>
                </p>
                <p id="product-price">
            ...
            <a href="pcgamer3.php" class="link"><div id="item3" class="product-template">
                <img src="pcgamer3.jpg" alt="" id="product-image">
                <p id="product-description">PC Gamer Neologic AMD Ryzen 5 5600g Radeon Vega 7 Integrado, 16GB 3200mhz, SSD 480GB M.2, Fonte 500w 80 Plus - Nli86304 <br>
                </p>
                <p id="product-price">
                    <span>R$ 2.840,53</span> à vista <br>
                    <span id="pix-price">no PIX com 10% de desconto</span>
                </p>
                <p id="buy-button">
                    Comprar
