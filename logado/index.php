...
<body>
    ...
    <main>
        ...
        <div id="product-area">
            ...
            <a href="rtx4090.php" class="link"><div id="item1" class="product-template">
            ...
            <a href="notebook1.php" class="link"><div id="item2" class="product-template">
            ...
            <a href="pcgamer2.php" class="link"><div id="item3" class="product-template">
