...
<body>
    ...
    <main>
        <div id="product-info">
            <div id="blank"></div>
            <div id="blank2"></div>
            <h1 id="product-name">Headset Gamer Havit, Drivers 53mm, Microfone Plugável, P2, PC, PS4, XBOX ONE, Preto - HV-H2002D
            </h1>
            <picture>
                <img src="periferico2.jpg" id="product-image">
            </picture>
            <div id="product-detail">
                ...
                <p id="product-method">
                    <span id="span1">R$ 193,57</span> <br>
                    Em até 10x de <span id="span2"> R$ 19,35</span> sem juros no cartão <br>
                    Ou em 1x no cartão com até <span id="span3">5% OFF</span>
                </p>
                <a href="pagamentop2.php"><p id="buy-button">
                    Comprar
                </p></a>
            </div>
        </div>   
